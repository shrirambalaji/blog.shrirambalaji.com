...
---
import compilerBuildSymbolsResolveLinkerImage from "./attachments/compiler-build-symbols-resolve-linker.png"
...
<Image src={compilerBuildSymbolsResolveLinkerImage} width={500} alt="Compiler Build Symbols Resolve Linker Diagram"/>
