...
draft: true
coverImage:
  src: "/src/content/post/attachments/rust-compilation-dark.png"
...
<ThemedImage alt="Rust Compilation Pipeline"
...
Okay, that was a lot of information. Let's get back to linking.
...
Now's the fun part - let's compile these files to object files.
...
Let's look at the symbol table of the object files using the `nm` command. 
...
Let's break down the symbol table:
