...
Symbols are how we go from variable names to memory addresses in machine instructions. 
...
## What does a Linker do (in linux)?

I wanted to understand platform specific linking mechanisms, but first we will look at it from a linux perspective. 
...
The rust compilation pipeline involves a series of steps 
