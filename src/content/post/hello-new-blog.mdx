...
I originally expected exports to be markdown files, but to my surprise it was a json dump of all my articles. Fortunately, hashnode has a neat Github Backup integration which I had enabled. So

![[Pasted image 20230920014219.png]]