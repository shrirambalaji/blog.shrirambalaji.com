...
Around `760ms` was being spend on just fonts, and I couldn't do anything about it ☹️. But hey, this isn't a post to dunk on hashnode - I know that it's a small team doing incredible work. I also had some interesting things I wanted to try and making a blog felt like the perfect starting point:
...
Since I wanted to move over things quickly and not spend a lot of time crafting the blog, I wanted to find an astro starter / theme.
