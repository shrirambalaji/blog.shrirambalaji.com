...
![[Pasted image 20230921000042.png]]
![[Pasted image 20230921000216.png]]

Around `760ms` was being spend on just fonts, and I couldn't do anything about it.
...
![[Pasted image 20230921000635.png]]

(I'm fully aware that Lighthouse scores don't always reflect perceived user experience based on [many]( https://calibreapp.com/blog/downsides-of-performance-score ) [writings](https://www.matuzo.at/blog/building-the-most-inaccessible-site-possible-with-a-perfect-lighthouse-score/) but hey - gotta be happy with the 100.)
